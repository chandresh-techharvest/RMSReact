                                                ...
                                                data && Object.keys(data).map((item, index) => (
                                                    ...
                                                    (item === 'clientMaster') ? (
                                                        Object.keys(data[item]).map((subItem, subIndex) => (
                                                            <>
                                                                {
                                                                    (subItem === 'createdAt' || subItem === 'updatedAt' && subItem !== '__v' && subItem !== 'role' && subItem !== '_id' && subItem !== 'password') ? (
                                                                        <div className="col-md-6" key={subIndex}>
                                                                            <div className="form-group">
                                                                                <h5>Client {subItem.charAt(0).toUpperCase() + subItem.slice(1)}</h5>
                                                                                <div className="help-block">{data[item][subItem].slice(0, 10)}</div>
                                                                            </div>
                                                                        </div>
                                                                    ) :

                                                                        (subItem !== 'ownerMasters' && subItem !== '__v' && subItem !== 'role' && subItem !== '_id' && subItem !== 'password') && (
                                                                            <div className="col-md-6" key={subIndex}>
                                                                                <div className="form-group">
                                                                                    <h5>Client {subItem.charAt(0).toUpperCase() + subItem.slice(1)}</h5>
                                                        ...
                                                        Object.keys(data[item]).map((subItem, subIndex) => (
                                                            <>
                                                                {
                                                                    (subItem === 'pincode' && subItem !== '__v' && subItem!=='_id') ? (
                                                                        <div className="col-md-6" key={subIndex}>
                                                                            <div className="form-group">
                                                                                <h5>Property {subItem.charAt(0).toUpperCase() + subItem.slice(1)}</h5>
                                                                                <div className="help-block"> {data[item][subItem].$numberDecimal}</div>
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        (subItem !== 'ownerMasters' && subItem !== '__v' && subItem!=='_id') && (
                                                                            <div className="col-md-6" key={subIndex}>
                                                                                <div className="form-group">
                                                                                    <h5>Property {subItem.charAt(0).toUpperCase() + subItem.slice(1)}</h5>
                                                                                    <div className="help-block">{data[item][subItem]}</div>
                                                        ...
                                                        Object.keys(data[item]).map((subItem, subIndex) => (
                                                            <>
                                                                {
                                                                    ((subItem === 'incrementPercentage' || subItem === 'securityDepositAmount' || subItem === 'monthlyRent' || subItem === 'incrementSchedule') && (subItem !== 'propertymaster' && subItem !== 'ownerMasters' && subItem !== 'clientMaster' && subItem !== '__v')) ? (
                                                                        <div className="col-md-6" key={subIndex}>
                                                                            <div className="form-group">
                                                                                <h5>Rent {subItem.charAt(0).toUpperCase() + subItem.slice(1)}</h5>
                                                                                <div className="help-block"> {data[item][subItem].$numberDecimal}</div>
                                                                            </div>
                                                                        </div>
                                                                    ) :

                                                                        (subItem === 'createdAt' || subItem === 'updatedAt' && subItem !== 'ownerMasters' && subItem !== 'propertymaster' && subItem !== 'clientMaster' && subItem !== '__v' && subItem !== '_id') ? (
                                                                            <div className="col-md-6" key={subIndex}>
                                                                                <div className="form-group">
                                                                                    <h5>Rent {subItem.charAt(0).toUpperCase() + subItem.slice(1)}</h5>
                                                                                    <div className="help-block"> {data[item][subItem].slice(0, 10)}</div>
                                                                        ...
                                                                        ) : ((subItem !== 'ownerMasters' && subItem !== 'propertymaster' && subItem !== 'clientMaster' && subItem !== '__v' && subItem !== '_id') && (
                                                                            <div className="col-md-6" key={subIndex}>
                                                                                <div className="form-group">
                                                                                    <h5>Rent {subItem.charAt(0).toUpperCase() + subItem.slice(1)}</h5>
                                                                                    <div className="help-block">{data[item][subItem]}</div>
                                                        ...
                                                        Object.keys(data[item]).map((subItem, subIndex) => (
                                                            (subItem === 'name' || subItem === 'phone' || subItem === 'email') && (
                                                                <div className="col-md-6" key={subIndex}>
                                                                    <div className="form-group">
                                                                        <h5>Owner {subItem.charAt(0).toUpperCase() + subItem.slice(1)}</h5>
                                                                        <div className="help-block"> {data[item][subItem]}</div>
                                                                    </div>
                                                                </div>
                                                            )
                                                        ...
                                                        (item === 'RentFrom' || item === 'RentTo' || item === 'paymentThreshold') ? (
                                                            <div className="col-md-6" key={index}>
                                                                <div className="form-group">
                                                                    <h5> {item.charAt(0).toUpperCase() + item.slice(1)}</h5>
                                                                    <div className="help-block">{data[item].slice(0, 10)}</div>
